...
def create_embeddings_to_submit(data_dir,
    ...
    model = GRUAutoencoder(
        ...
        use_gpu=True, 
        att_dropout=0.20990257265289514, 
        fc_dropout=0.2216968971838151, 
        dec_dropout=0.17277800745684632,
        gru_dropout=0.11649165607921677, 
        n_heads_attn=2,  
        num_attn_layers=1  
    )
    optimizer = torch.optim.AdamW(model.parameters(), lr=7.52374288453485e-05, weight_decay=2.62108787826544e-06)
    train_model(
        model, 
        dataset_train,
        dataloader,
